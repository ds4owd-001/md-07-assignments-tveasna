...
The tidyverse package multiple functions, it can be used to transform data set, to work with date data and to do data visualization.
...
No, because it looks a bit untidy.
